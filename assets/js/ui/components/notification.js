class Notification {
  ...
  #init(modalId) {
    ...
    if (!this.#modalElement) {
      console.warn(`Notification modal element #${modalId} not found.`);
      return;
    }
    ...
    if (typeof bootstrap !== 'undefined') {
      ...
      console.error('Bootstrap is not loaded. Notification modal cannot be initialized.');
    }
  }
  ...
  #show(type, title, message) {
    if (!this.#modal || !this.#modalElement) {
      console.warn('Notification modal is not ready.');
      return;
    }
